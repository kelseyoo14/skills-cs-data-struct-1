...
def has_exotic_animals(animals):
    ...
    Put runtime here:
    -----------------
    [O(n) -- technically O(n*m) where m is the length of the word being checked for in 'animals']
...
def sum_zero_3(numbers):
    ...
    Put runtime here:
    -----------------
    [O(n^2) -- technically O(n^2*m) where m is the length of the 'results' list]
